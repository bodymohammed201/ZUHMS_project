...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Invoices</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Invoice Printing </span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="card card-invoice">
                <div class="card-body">
                    <div class="invoice-header">
                        <h1 class="invoice-title">Invoice for Single Service </h1>
                        <div class="billed-from">
                            <h6>Invoice for Single Service </h6>
                            <p>201 Engineers<br>
                    ...
                    <div class="row mg-t-20">
                        ...
                        <div class="col-md">
                            ...
                            <p class="invoice-info-row"><span>Depatment</span> <span></span>{{ Request::get('section_id') }}</p>
                        </div>
                    </div>

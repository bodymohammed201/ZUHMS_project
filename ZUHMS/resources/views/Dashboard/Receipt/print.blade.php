...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Receipt Voucher</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Voucher Printing</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="card card-invoice">
                <div class="card-body">
                    <div class="invoice-header">
                        <h1 class="invoice-title">Receipt Voucher</h1>
                    ...
                    <div class="row mg-t-20">
                        <div class="col-md">
                            <label class="tx-gray-600">Voucher Details</label>
                    ...
                    <a href="#" class="btn btn-danger float-left mt-3 mr-2" id="print_Button" onclick="printDiv()">
                        <i class="mdi mdi-printer ml-1"></i>printing
                    </a>
                </div>
            </div>
        </div>

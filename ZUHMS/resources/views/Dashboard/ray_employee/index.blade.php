...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Scans</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Employee List</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table style="text-align: center" class="table text-md-nowrap" id="example">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>

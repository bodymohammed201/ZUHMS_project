		...
		<ul class="side-menu">
			...
			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
					...
					</svg><span class="side-menu__label">Doctor Checkup</span><i class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					<li><a class="slide-item" href="{{ route('invoices.index') }}">Checkup List</a></li>
					<li><a class="slide-item" href="{{route('completedInvoices')}}">Finished Checkup List</a></li>
					<li><a class="slide-item" href="{{route('reviewInvoices')}}">Review List</a></li>
				</ul>
			</li>
			...
			<!-- <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{route('list.patients')}}">Patients list</a></li>
                             <li><a class="slide-item" href="{{route('chat.patients')}}">المحادثات الاخيرة</a></li> 
							<li><a class="slide-item" href="{{route('chat.patients')}}">Last Chats</a></li> -->

    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{route('insurance.create')}}" class="btn btn-primary">Add Insurane</a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table text-md-nowrap text-center" id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="{{$insurance->status == 1 ? 'bg-success':'bg-danger'}}">{{$insurance->status == 1 ? 'Enable' : 'Not Enable '}}</td>

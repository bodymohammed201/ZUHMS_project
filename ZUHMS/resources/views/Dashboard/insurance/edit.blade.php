...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{trans('main-sidebar_trans.Services')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Insurance/Edit')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="card-body">
                ...
                <form action="{{route('insurance.update','test')}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label>Bearing Percentage %</label>

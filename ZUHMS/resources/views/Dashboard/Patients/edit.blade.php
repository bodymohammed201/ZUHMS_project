...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Patient</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Edit Patient data</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
            ...
            <div class="card-body">
                <form action="{{route('Patients.update','test')}}" method="post" autocomplete="off">
                    ...
                    <div class="col">
                        <div class="col-3">
                            <label>Status </label>
                            <input type="text" name="status" value="{{$Patient->status}}" class="form-control @error('Phone') is-invalid @enderror" required>
                        </div>
                        <br>

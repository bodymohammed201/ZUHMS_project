                            ...
                            <div class=" tab-menu-heading">
                                <div class="tabs-menu1">
                                    ...
                                    <ul class="nav panel-tabs main-nav-line">
                                        <li class="nav-item"><a href="#tab1" class="nav-link active" data-toggle="tab">Patient Informations</a></li>
                                        <li class="nav-item"><a href="#tab2" class="nav-link" data-toggle="tab">Invoices</a>
                                        </li>
                                        <li class="nav-item"><a href="#tab3" class="nav-link" data-toggle="tab">payment</a>
                                        </li>
                                        <li class="nav-item"><a href="#tab4" class="nav-link" data-toggle="tab"> Account detection
                                                </a></li>
                                        <li class="nav-item"><a href="#tab5" class="nav-link" data-toggle="tab">rays</a>
                                        </li>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="alert alert-danger">
                                                            <span class="text-danger"> {{$Debit - $credit}} {{ $Debit-$credit > 0 ? 'Deptor' :'Creditor'}}</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>

...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Patient Processes </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Tests</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <table style="text-align: center" class="table text-md-nowrap" id="example1">
                        <thead>
                            <tr>
                                ...
                                <th>requirement</th>
                                <th>Doctor Name </th>
                                <!--  <th>ray doctor name </th>
                                <th>ray doctor comment </th>
                                <th>processes</th>
-->
                            </tr>
                        </thead>

...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">details</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ patient Details</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                            ...
                            <div class=" tab-menu-heading">
                                <div class="tabs-menu1">
                                    ...
                                    <ul class="nav panel-tabs main-nav-line">
                                        <li class="nav-item"><a href="#tab1" class="nav-link active" data-toggle="tab">The patient's Record</a></li>
                                        <!--  <li class="nav-item"><a href="#tab2" class="nav-link" data-toggle="tab">The Ray</a></li>
                                        <li class="nav-item"><a href="#tab3" class="nav-link" data-toggle="tab">The Laboratory</a> -->
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div class="timeline-wrapper {{ $loop->iteration % 2 == 0 ? 'timeline-inverted' : '' }} timeline-wrapper-primary">
                                                ...
                                                <div class="timeline-panel">
                                                    <div class="timeline-heading">
                                                        <h6 class="timeline-title">Doctor say: </h6>
                                                    </div>

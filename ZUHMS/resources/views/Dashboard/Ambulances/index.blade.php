...
<div class="breadcrumb-header justify-content-between">
	<div class="my-auto">
		<div class="d-flex">
			<h4 class="content-title mb-0 my-auto">Ambluance</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Ambluance cars </span>
		</div>
	</div>
</div>
<!-- breadcrumb -->
		...
		<div class="card">
			<div class="card-header pb-0">
				<div class="d-flex justify-content-between">
					<a href="{{route('Ambulance.create')}}" class="btn btn-primary">Add New Car </a>
				</div>
			</div>
			<div class="card-body">
					...
					<table class="table text-md-nowrap" id="example">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{$ambulance->car_type == 1 ? 'Owened' :'rent'}}</td>
								<td>{{$ambulance->driver_name}}</td>
								<td>{{$ambulance->driver_license_number}}</td>
								<td>{{$ambulance->driver_phone}}</td>
								<td>{{$ambulance->is_available == 1 ? 'Active':' Not Active'}}</td>
